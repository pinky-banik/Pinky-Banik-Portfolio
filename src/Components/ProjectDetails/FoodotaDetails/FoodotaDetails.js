...
import img1 from '../../../img/foodota334.jpg';
import img2 from '../../../img/foodota00.png';
import img3 from '../../../img/foodota01.png';

const FoodotaDetails = ({ open, handleClose }) => {
    return (
                    ...
                    <div className="container">
                        ...
                        <div className="row container">
                            <div className="col-12 text-white details">
                                ...
                                <p>
                                    <span>Link: </span>
                                    <a href="https://github.com/Yasin440/Fodota-Delivery-Client-site" target="_blank" rel='noreferrer'>ClientCode
                                    </a> | <a href="https://github.com/Yasin440/Fodota-Delivery-Server-site" target="_blank" rel='noreferrer'>ServerCode
                                    </a> | <a href="https://foodota-firebase-mongodb.web.app/" target="_blank" rel='noreferrer'>Live</a>
                                </p>
                                <p>
